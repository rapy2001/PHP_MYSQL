            ...
            success:function(data){
                ...
                if(data.flg == 1)
                {
                    ...
                    $.each(data.movies,function(key,movie){
                        ...
                        $("#movies_div")
                        .append('<div><img src = "' + imageUrl + '" alt = "error" /><h4>' + movie.year + '</h4><h3>' + movie.rating + '</h3><h2>' + movie.name + '</h2><h4>' + movie.genre + '</h4><h3>' + movie.director +'</h3><p>'+ movie.description.substring(0,50) + '</p><a href = "viewMovie.php?id=' + movie.movie_id + '">View</a></div>');
                    });
